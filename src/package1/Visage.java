...
public class Visage implements IObjetAnimable{
    ...
    * LARGEUR_MIN
    * @param haut hauteur du visage. La hauteur doit être sup  rieure à
    * HAUTEUR_MIN
    *
    ...
    */
    ...
    public void dessiner(Graphics g) {
    	...
    	g2.translate(xhg, yhg);
        // dessiner le contour du visage
        g2.drawOval(xhg, yhg, largeur, hauteur);

        // dessiner la bouche
        if (impassible) {
            g2.drawLine(xhg + largeur / 4, yhg + (2 * hauteur) / 3,
                    xhg + (3 * largeur) / 4, yhg + (2 * hauteur) / 3);
        } else {
            g2.drawArc(xhg + largeur / 4, yhg + (2 * hauteur) / 3,
        ...
        g2.drawOval(xhg + largeurOeil, yhg + hauteurOeil, largeurOeil,
                hauteurOeil);
        g2.drawOval(xhg + 3 * largeurOeil, yhg + hauteurOeil, largeurOeil,
                hauteurOeil);
